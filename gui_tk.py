...
button_pokaz_szczegoly=Button(ramka_lista_uzytkownikow, text="Pokaz szczegóły:", command=pokaz_szczegoly_uzytkownika)
...
button_dodaj_uzytkownika=Button(ramka_lista_uzytkownikow, text="Dodaj użytkownika:", command=dodaj_uzytkownika)
button_dodaj_uzytkownika.grid(row=5, column=0, columnspan=2)

#ramka_szczegóły obiektu
...
label_miejscowosc.grid(row=1, column=7,)
